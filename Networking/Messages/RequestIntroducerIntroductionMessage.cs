...
// Type: SKSSL.Networking.Messages.RequestIntroducerIntroductionMessage
...
namespace SKSSL.Networking.Messages
{
  public class RequestIntroducerIntroductionMessage : MessageBase
  {
    ...
    public override void WritePayload(IValueWriter writer)
    {
      ...
      writer.WriteBytes(this.InternalOwnEndPoint.Address.GetAddressBytes());
      writer.WriteInt32(this.InternalOwnEndPoint.Port);
    ...
    public override void ReadPayload(IValueReader reader)
    {
      ...
      this.InternalOwnEndPoint = new IPEndPoint(new IPAddress(reader.ReadBytes()), reader.ReadInt32());
